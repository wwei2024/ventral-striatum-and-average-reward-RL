...
holding_time_3     = params.holding_time_3
cue_duration_aud_3 = params.cue_duration_aud_3
...
class cue_input(): 
    def __init__(self,np_seed,pretrain=False): 
        ...
        self.holding_time_3     = dict(zip(self.cue_types,holding_time_3))         
        self.cue_duration_aud_3 = dict(zip(self.cue_types,cue_duration_aud_3))
    ...
    def reset(self): 
        ...
        self.cue_duration_aud = self.cue_duration_aud_3[self.cue_type]
        self.holding_time     = self.holding_time_3[self.cue_type]
    ...
    def train(self,sess,rollout,batch_rnn_state_VS,reward_rate,value_rate):
        ...
        for k in range(self.batch_size):             
            expected_rewards_VS[k] = rewards[k] - reward_rate + \
                                     values_VS[k,1:self.time_horizon+1] - \
